# Record Detail Sheet Specification

## Purpose

Defines the modal bottom sheet that displays the full data for a single cell record when the user taps a record row in the SessionDetailScreen.

## Scope

This spec covers the RecordDetailSheet composable's content sections, scenarios, and dismiss behavior. It does not define:
- The SessionDetailScreen record list layout (see `ui/spec.md`).
- Cell identity fields (see `cell-info/spec.md`).
